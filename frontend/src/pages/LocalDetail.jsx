...
function LocalDetail() {
  ...
  // MOVE handleAdLoaded HERE (inside component)
  ...
  const fetchArticleDetail = async () => {
    try {
      ...
      const [relatedRes, mixedRes] = await Promise.all([
        ...
        fetch(`${API_BASE_URL}/news/mixed-feed/${id}?limit=28`)
      ]);
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <CategoryBannerAd position="category-banner" page="article" category="local" />
              ...
              <div className="flex gap-8">
                ...
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 xl:hidden">
                    ...
                    {/* Related Articles - Show as fallback when we don't have extra mixed news */}
